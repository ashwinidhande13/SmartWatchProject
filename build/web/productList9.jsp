...
<html>
    ...
    <body>
        ...
        <br><br><br><br><br><br>
    <center><img src="images/asus1.jpg" align="center" height="250px" width="350px" /></center>
    ...
    <%
        ...
        ResultSet res;
        res = st.executeQuery("select * from productdetails where productID= " + 9);
        while (res.next()) {
    %>                        
    ...
    <table>
        ...
        <%
            res = st.executeQuery("select * from productreview where productID= " + 9);
            int count = 0;
            int rating = 0;
            int average = 0;
            while (res.next()) {
    ...
    <form action="productList10.jsp" method="post" id="form4">
