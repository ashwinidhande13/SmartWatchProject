...
<html>
    ...
    <body>
        ...
        <br><br><br><br><br><br>
    <center><img src="images/apple8.jpg" align="center" height="250px" width="350px" /></center>
    ...
    <%
        ...
        ResultSet res;
        res = st.executeQuery("select * from productdetails where productID= " + 4);
        while (res.next()) {
    %>                        
    ...
    <table>
        ...
        <tr>
            <th>          Model Name      </th>
            <td>          Watch Series 4 - 42 mm Space Grey Aluminium Case with Black Sport Band      </td>
        </tr>
    ...
    <table>
        ...
        <%
            res = st.executeQuery("select * from productreview where productID= " + 4);
            int count = 0;
            int rating = 0;
            int average = 0;
            while (res.next()) {
    ...
    <form action="productList1.jsp" method="post" id="form4">
        <button class="button" type="Submit" form="form4" value="next"><span>Next Product</span></button>  
    </form>
    <form action="productList5.jsp" method="post" id="form5">
        <button class="button" type="Submit" form="form5" value="next"><span>Android SmartWatches</span></button>  
    </form>
</body>
</html>
