...
<html>
    ...
    <body>
        ...
        <br><br><br><br><br><br>
    <center><img src="images/apple11.jpeg" align="center" height="250px" width="350px" /></center>
    ...
    <%
        ...
        ResultSet res;
        res = st.executeQuery("select * from productdetails where productID= " + 1);
        while (res.next()) {
    %>                        
    ...
    <table>
        ...
        <tr>
            <th>          Model Name      </th>
            <td>          Watch Series 1 - 42 mm Space Grey Aluminium Case with Black Sport Band      </td>
        </tr>
    ...
    <table>
        ...
        <tr>
            ...
            <td> iPhone 5, 5c, 5s, SE, 6, 6 Plus, 6s, 6s Plus, 7 or 7 Plus and iOS 10 or Later      </td>
        </tr>
    ...
    <table>
        ...
        <%
            res = st.executeQuery("select * from productreview where productID= " + 1);
            int count = 0;
            int rating = 0;
            int average = 0;
            while (res.next()) {
    ...
    <form action="productList2.jsp" method="post" id="form4">
