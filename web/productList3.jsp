...
<html>
    ...
    <center><img src="images/apple3.jpg" align="center" height="250px" width="350px" /></center>
    ...
    <%
        ...
        ResultSet res;
        res = st.executeQuery("select * from productdetails where productID= " + 3);
        while (res.next()) {
    %>                        
    ...
    <table>
        ...
        <tr>
            <th>          Model Name      </th>
            <td>          Watch Series 3 - 42 mm Space Grey Aluminium Case with Black Sport Band      </td>
        </tr>
    ...
    <table>
        ...
        <%
            res = st.executeQuery("select * from productreview where productID= " + 3);
            int count = 0;
            int rating = 0;
            int average = 0;
            while (res.next()) {
    ...
    <form action="productList4.jsp" method="post" id="form4">
